...
async def get_table_data(sheet_id, worksheet, state: FSMContext):
    ...
    if worksheet == 0:
        ...
        await state.update_data(
            notification_chat=row_data[1],
            reg_1=row_data[2],
            reg_2=row_data[3],
            reg_3=row_data[4],
            send_client_1=row_data[5],
            send_client_2=row_data[6],
            send_client_3=row_data[7],
            client_status=row_data[8],
            ref_link_1=row_data[9],
            ref_link_2=row_data[10],
            bank_1=row_data[11],
            bank_2=row_data[12],
            bank_3=row_data[13],
            bank_4=row_data[14],
            partner_chat=row_data[15],
            tos=row_data[16],
            add_partner_1=row_data[17],
            add_partner_2=row_data[18],
            add_partner_3=row_data[19],
            add_partner_4=row_data[20],
            add_partner_5=row_data[21]
            )
    elif worksheet == 1:
        range_name = "A2:T2"
        value = await get_google_sheet_data(sheet_id, range_name, worksheet)
